...
module "db_subnet_group" {
  ...
  subnet_ids = [data.terraform_remote_state.net.outputs.sub-priv5, data.terraform_remote_state.net.outputs.sub-priv6] #[module.net.sub-priv5, module.net.sub-priv6]
}
...
module "db_option_group" {
  ...
  vpc_security_group_memberships = [data.terraform_remote_state.net.outputs.rds-sg] #[module.net.rds-sg]
}

module "db_instance" {
  source                 = "../../modules/rds/db_instance"
  vpc_security_group_ids = [data.terraform_remote_state.net.outputs.rds-sg]
}
